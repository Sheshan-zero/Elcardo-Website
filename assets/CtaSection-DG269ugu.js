import{a9 as oe,l as P,aa as le,ab as f,ac as L,ad as K,ae as H,S as ue,af as ce,ag as he,ah as Y,ai as me,M as Z,r as a,aj as fe,a as G,p as de,V as b,a7 as q,ak as Q,P as ve,al as pe,am as xe,an as ge,d as _e,h as ee,j as t,m as V,B as Se}from"./index-B-Pi4Vdg.js";import{S as te}from"./ScrollTrigger-CB6UHAJl.js";import{_ as ye,V as we}from"./RollerGatesPage-Dl6LjRlg.js";import{P as De}from"./PerspectiveCamera-GbV8ASlA.js";import{E as Me}from"./Environment-j2PH88hh.js";import{v as Be}from"./constants-DsG5Zwvj.js";class Te extends oe{constructor(e=new P){super({uniforms:{inputBuffer:new f(null),depthBuffer:new f(null),resolution:new f(new P),texelSize:new f(new P),halfTexelSize:new f(new P),kernel:new f(0),scale:new f(1),cameraNear:new f(0),cameraFar:new f(1),minDepthThreshold:new f(0),maxDepthThreshold:new f(1),depthScale:new f(0),depthToBlurRatioBias:new f(.25)},fragmentShader:`#include <common>
